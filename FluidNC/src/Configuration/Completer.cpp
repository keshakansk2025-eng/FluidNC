...
namespace Configuration {
    Completer::Completer(const char* key, int32_t reqMatch, char* matchedStr) :
...
int num_initial_matches(const char* key, int32_t keylen, int32_t matchnum, char* matchname) {
    int32_t nfound = 0;
