...
namespace Spindles {
    namespace VFD {
        class SiemensV20Protocol : public VFDProtocol {
        protected:
            ...
            float _FreqScaler =
                float(-16384.0) /
                _maxFrequency;  // SPEED_SCALING Internally it is standardized to 16384. (16384 / 400) With this scaling HSW and HIW are transferred via the Modbus register.
