...
namespace Pins {
    ...
    void GPIOPinDetail::setDriveStrength(int32_t n, PinAttributes attr) {
    ...
    void IRAM_ATTR GPIOPinDetail::write(int32_t high) {
        if (high != _lastWrittenValue) {
            ...
            int32_t value = _inverted ^ (bool)high;
            gpio_write(_index, value);
        }
    }
    int32_t IRAM_ATTR GPIOPinDetail::read() {
