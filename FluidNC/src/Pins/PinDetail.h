...
namespace Pins {
    ...
    public:
        ...
        PinDetail(int32_t number) : _index(number) {}
        ...
        // I/O:
        virtual void          write(int32_t high) = 0;
        virtual void          synchronousWrite(int32_t high);
        ...
        inline int32_t number() const { return _index; }
