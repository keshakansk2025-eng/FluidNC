...
static esp_err_t mount_to_vfs_fat(int32_t max_files, sdmmc_card_t* card, uint8_t pdrv, const char* base_path) {
    FATFS*    fs = NULL;
    esp_err_t err;
...
bool sd_init_slot(uint32_t freq_hz, int32_t cs_pin, int32_t cd_pin, int32_t wp_pin) {
    esp_err_t err;
